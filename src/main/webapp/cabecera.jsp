				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="<%=url%>AutoresController?op=listar">Autores</a></li>
						<li class="nav-item"><a class="nav-link" href="<%=url%>EditorialControllers?op=Editorial">Editorial</a>
						</li>
